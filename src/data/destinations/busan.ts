...
• Learn basic Korean phrases for better communication`,
    ...
    culturalExpectations: {
      dressCode: [
        'Conservative dress appreciated in temples and traditional areas - cover shoulders and knees out of respect for Korean cultural values',
        'Modern, trendy fashion widely acceptable in downtown Busan - the city is fashion-forward and international like Seoul',
        'Beach attire appropriate only at beaches and pools - swimwear in city areas draws unwanted attention from locals',
        'Layers recommended for unpredictable weather - bring light cardigan or jacket for temperature changes throughout the day',
        'Comfortable walking shoes essential - Busan has many hills and stairs requiring good footwear for safe navigation',
        'Neat, clean appearance highly valued - Koreans judge heavily on personal grooming and tidy clothing presentation',
        'Hide expensive jewelry and accessories - flashy items make you a potential robbery target; keep valuables minimal and concealed'
      ],
      behaviorNorms: [
      ...
      perception: [
        ...
        'Locals often go out of their way to help solo women travelers with directions and recommendations - hospitality culture is exceptionally strong',
        'Women-only subway cars available during peak hours for added comfort and safety - clearly marked with pink signs',
        'Hotel and hostel staff trained to assist solo female guests with safety concerns and local navigation advice',
        'Conservative Confucian values create respectful environment - Korean men rarely approach foreign women inappropriately',
        'Business owners and restaurant staff welcoming to solo diners - you won\'t feel out of place eating or shopping alone',
        'Local women often travel alone and readily share safety advice with fellow solo female travelers at hostels and cafes'
      ]
    },
    bestTimeToVisit: {
