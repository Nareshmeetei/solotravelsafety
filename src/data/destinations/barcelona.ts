...
• Beach areas are safe during day but use caution at night`,
  ...
  culturalSensitivity: {
    culturalDos: [
      ...
      'Embrace late dining culture - lunch is 2-4pm, dinner starts after 9pm, plan accordingly',
      'Respect siesta time (2-5pm) when many smaller shops close - use this time for sightseeing'
    ],
    culturalDonts: [
      'Don\'t wear revealing clothing when visiting religious sites or traditional neighborhoods',
      'Don\'t discuss Franco era or Catalan independence politics unless you know someone well',
      'Don\'t expect everything to be in Spanish - Catalan is the primary language and deserves respect',
      'Don\'t be loud or disruptive on public transport - Catalans value personal space and quiet behavior',
